# Amero Tipping Bot - Telegram Amero Tipbot.
 
#### Amero crypto currency tipbot for [Telegram](https://telegram.org)
...
* In order to run the tip-bot effectively, a Bitcoin-core based client is needed. For this git Amero-Core is used , but any major alternate crypto-currency client could easily be incorperated. 

## Setup

* Download the git
`git clone https://github.com/jopea302/amerobot-telegram.git`
